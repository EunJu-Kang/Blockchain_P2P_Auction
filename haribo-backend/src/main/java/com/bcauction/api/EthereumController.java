...
public class EthereumController {
	...
	@Autowired
	public EthereumController(IEthereumService explorerService, IAuctionContractService auctionContractService) {
...
//        });
		...
		System.out.println(this.auctionContractService.경매정보조회("0x2fFa3C3ac99f1dE1aDE6bA6eCdeFefc290214f12"));
		System.out.println(경매정보목록);
		return 경매정보목록;
	}
